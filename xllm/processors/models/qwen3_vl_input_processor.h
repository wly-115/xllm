...
#include "processors/models/qwen3_vl_video_processor.h"

namespace xllm {

class Qwen3VLInputProcessor : public MultimodalInputProcessor {
 public:
  explicit Qwen3VLInputProcessor(const ModelArgs& args);
  ~Qwen3VLInputProcessor() override = default;
 ...
 private:
  ...
  Qwen3VLVideoProcessor video_processor_;
};
