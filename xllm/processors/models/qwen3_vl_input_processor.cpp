...
Qwen3VLInputProcessor::Qwen3VLInputProcessor(const ModelArgs& args)
    : image_processor_(args), video_processor_(args) {}

bool Qwen3VLInputProcessor::process(const MMInput& inputs, MMData& datas) {
...
bool Qwen3VLInputProcessor::process_images_embedding(
...
bool Qwen3VLInputProcessor::process_images(std::vector<torch::Tensor> images,
                                           MMData& mm_datas) {
...
bool Qwen3VLInputProcessor::process_videos(
    std::vector<torch::Tensor> videos,
    std::vector<VideoMetadata> video_meta_list,
    MMData& mm_datas) {
  torch::Tensor pixel_values;
